...
class Histogram_Plotter(Plotter):
    def __init__(self, y, y_pred, y2, y_pred2):
        Plotter.__init__(self, y, y_pred, y2, y_pred2)
    ...
    def plot(self):
        ...
        plt.title('Model 1: Histogram of Residuals', fontsize= 15)
...
class Distplot(Plotter):
    ...
    def plot(self):
        ...
        plt.title('Model 1: Distribution of Residuals')
...
class Scatter_Plot(Plotter):
    def __init__(self, y, y_pred, y2, y_pred2):
        Plotter.__init__(self, y, y_pred, y2, y_pred)
